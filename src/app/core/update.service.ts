...
export class UpdateService {
  ...
  migrateData(): void {
    ...
    this.store.select(storageVersionSelector).pipe(take(1)).subscribe((storageVersion) => {
      if (storageVersionV1) {
      ...
      if (isVersionNewer('1.10.0', storageVersion)) {
        ...
        storageVersion = '1.10.0';
        this.store.dispatch(setStorageVersion('1.10.0'));
      }
      if (isVersionNewer('1.12.0', storageVersion)) {
        ...
        this.store.dispatch(setStorageVersion('1.12.0'));
